 ...
 */
class getVendedorRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\VendedorRepository' shared autowired service.
     *
     * @return \App\Repository\VendedorRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'VendedorRepository.php';

        return $container->privates['App\\Repository\\VendedorRepository'] = new \App\Repository\VendedorRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
